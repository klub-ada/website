...
const baseButton = tv({
  ...
  variants: {
    ...
    variant: {
      primary:
        "border border-black text-white enabled:hover:text-black bg-red enabled:hover:shadow-button enabled:hover:mt-minus-4 enabled:hover:ml-1",
      secondary:
        "border border-black text-black bg-white enabled:hover:shadow-button enabled:hover:mt-minus-4 enabled:hover:ml-1",
    },
    disabled: {
